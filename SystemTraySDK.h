...
public:
	...
	BOOL ClearCheckedItems();
	BOOL ClearGrayedItems();
	BOOL ClearGrayedPositions();
	BOOL SetCheckedItems(HMENU hMenu);
	BOOL SetGrayedItems(HMENU hMenu);
	BOOL SetGrayedPositions(HMENU hMenu);
    BOOL CheckMenuItem(UINT uiCmd, BOOL bCheck);
    BOOL GrayMenuItem(UINT uiCmd, BOOL bGray);
	BOOL GrayMenuPosition(UINT uiPos, BOOL bGray);
...
protected:
	...
	vector<UINT>	m_CheckedItems;
	vector<UINT>	m_GrayedItems;
	vector<UINT>	m_GrayedPositions;
