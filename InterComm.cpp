...
#define INTERCOMM_WINDOWNAME	"JoyTray_InterComm"
#define INTERCOMM_SERVERNAME	"JoyTray_Server"
#define INTERCOMM_CLIENTNAME	"JoyTray_Client"
#define INTERCOMM_MUTEXNAME		"JoyTray_Mutex"
...
LRESULT CALLBACK CInterComm::StaticWndProc(HWND hWnd, UINT uMsg, WPARAM wParam, LPARAM lParam)
{
	...
	{
		pParent = (CInterComm*) GetWindowLongPtr(hWnd, GWL_USERDATA);
