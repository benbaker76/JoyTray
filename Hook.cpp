...
LRESULT CALLBACK MouseHookProc(INT nCode, WPARAM wParam, LPARAM lParam)
{
	...
	static MOUSEEVENTARGS mouseArgs = {0};
	static POINT lastMousePoint = {0};
    ...
    {
        case WM_LBUTTONDOWN:
            mouseArgs.Button = MOUSE_LBUTTONDOWN;
            break;
		case WM_LBUTTONUP:
            mouseArgs.Button = MOUSE_LBUTTONUP;
            break;
        case WM_RBUTTONDOWN:
            mouseArgs.Button = MOUSE_RBUTTONDOWN;
            break;
		case WM_RBUTTONUP:
            mouseArgs.Button = MOUSE_RBUTTONUP;
            break;
		case WM_MBUTTONDOWN:
            mouseArgs.Button = MOUSE_MBUTTONDOWN;
            break;
		case WM_MBUTTONUP:
            mouseArgs.Button = MOUSE_MBUTTONUP;
            break;
        case WM_MOUSEWHEEL:
	...
	if(g_MouseDrag)
		ProcessMouseClickLock(&mouseArgs);
